...
namespace web
{
    public class Startup
    {
        ...
        {
            string connectionString = dal.CryptoInvestContextFactory.GetConnectionString();

            services.AddDbContext<dal.CryptoInvestContext>(options =>
            ...
            services.AddAuthentication(CookieAuthenticationDefaults.AuthenticationScheme)
                .AddCookie(opt => {
                    opt.Cookie.Name = "cryptoinvest_auth";
